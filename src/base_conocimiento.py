...
REGLAS = [
    ...
    "condiciones": [ ("requiere_portabilidad", True),("tiene_ipad", True),("tiene_tablet_android", True),("tiene_iphone", True)],
    "conclusion": ("recomendar_ibis_paint", True),
    "certeza": 0.83,
    "justificacion": "Ibis Paint permite crear ilustraciones de forma rápida desde cualquier dispositivo.",
    },
    {
    "nombre": "R49",
    "descripcion": "portabilidad",
    "condiciones": [ ("requiere_portabilidad", True),("tiene_tablet_android", True)],
    "conclusion": ("recomendar_ibis_paint", True),
    "certeza": 0.83,
    "justificacion": "Ibis Paint permite crear ilustraciones de forma rápida desde cualquier dispositivo.",
    },
    ...
    "nombre": "R50",
    "descripcion": "portabilidad",
    "condiciones": [ ("requiere_portabilidad", True),("tiene_iphone", True)],
    "conclusion": ("recomendar_ibis_paint", True),
    "certeza": 0.83,
    "justificacion": "Ibis Paint permite crear ilustraciones de forma rápida desde cualquier dispositivo.",
    }
